...
namespace :spec do
  task :migrations do |app|
    ...
    sh "bundle exec rails generate bigbluebutton_rails:install 2.4.0 --migration-only --force"
    ...
    cd "spec/rails_app/"
    sh "bundle exec rails destroy bigbluebutton_rails:install 2.4.0 --migration-only"
