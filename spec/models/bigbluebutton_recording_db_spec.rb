...
describe BigbluebuttonRecording do
  ...
  context "db" do
    ...
    it { should have_db_column(:start_time).of_type(:decimal) }
    it { should have_db_column(:end_time).of_type(:decimal) }
    it { should have_db_column(:expiration_date).of_type(:decimal) }
