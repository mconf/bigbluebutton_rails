...
describe BigbluebuttonPlaybackFormat do
  ...
  context "allows nil for delegates to playback_type" do
    let(:target) { FactoryBot.create(:bigbluebutton_playback_format, playback_type: nil) }
  ...
  it("alias :format_type to :identifier") {
    target = FactoryBot.create(:bigbluebutton_playback_format)
  ...
  describe "#ordered" do
    context "when there's a default set" do
      ...
      let!(:type1) { FactoryBot.create(:bigbluebutton_playback_type, default: false) }
      let!(:type2) { FactoryBot.create(:bigbluebutton_playback_type, default: false) }
      before {
        @format1 = FactoryBot.create(:bigbluebutton_playback_format, playback_type: type1)
        @format2 = FactoryBot.create(:bigbluebutton_playback_format, playback_type: type2)
        @format3 = FactoryBot.create(:bigbluebutton_playback_format, playback_type: type_default)
        @format4 = FactoryBot.create(:bigbluebutton_playback_format, playback_type: nil)
      }
    ...
    context "when there's no default set" do
      ...
      before {
        @format1 = FactoryBot.create(:bigbluebutton_playback_format, playback_type: type1)
        @format2 = FactoryBot.create(:bigbluebutton_playback_format, playback_type: type2)
        @format3 = FactoryBot.create(:bigbluebutton_playback_format, playback_type: nil)
      }
      subject { BigbluebuttonPlaybackFormat.ordered }
  ...
  describe "#length_in_secs" do
    it { FactoryBot.create(:bigbluebutton_playback_format, length: nil).length_in_secs.should eql(0) }
    it { FactoryBot.create(:bigbluebutton_playback_format, length: "").length_in_secs.should eql(0) }
    it { FactoryBot.create(:bigbluebutton_playback_format, length: -1).length_in_secs.should eql(0) }
    it { FactoryBot.create(:bigbluebutton_playback_format, length: 0).length_in_secs.should eql(0) }
    it { FactoryBot.create(:bigbluebutton_playback_format, length: 5).length_in_secs.should eql(300) }
    it { FactoryBot.create(:bigbluebutton_playback_format, length: 99).length_in_secs.should eql(5940) }
  end
end
