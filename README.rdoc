...
Since version 1.4.0, it's recommended that you use the gem {strong_parameters}[https://github.com/rails/strong_parameters] in your application.
If you do, set the <tt>config.active_record.whitelist_attributes</tt> property in your <tt>config/application.rb</tt>:
