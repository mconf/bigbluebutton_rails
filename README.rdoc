...
* Integration with recordings: meetings can be recorded, the list of recordings retrieved and recordings can be played.
...
This generator will create a migration file and a language file.
...
they depend on jQuery (use the gem <tt>jquery-rails</tt>) and a css file also provided by this gem.
...
If you need more help to setup the gem, check out the test application at <tt>spec/rails_app/</tt>!
...
Prepare the rails_app used for tests:
  ...
  rake setup:rails_app:populate            # to create fake data
