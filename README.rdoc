...
Since this task can comsume quite some time if your server has a lot of recordings,
it is recommended to run it periodically in background. To do that, you can use the
...
update the application database. This task can be used to update the recordings from whenever/cron.
