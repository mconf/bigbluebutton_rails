...
The routes to bigbluebutton_rails can be generated with the helper . See the example below:
...
Internally, they use the same algorithm to decide if the user can join or not:
